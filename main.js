  ...
  ar: {
    translation: {
      ...
      home: {
        ...
        about: {
          chip: 'نبذة',
          title: 'حيث <span class="hg">التصميم</span><br/>يلتقي بالحرفة<br/>ويلامس الصوت.',
          p1: 'أتحرك بين الصوت والهوية وتقديم الأفكار الرقمية. ما يربط بينها هو الوضوح.',
          p2: 'عملي يمتد من بناء العلامات والحركة إلى مفاهيم التطبيقات والسرد الصوتي، والفكرة عندي لا تخرج إلا نظيفة ومباشرة.',
